...
Для проведения запланированных проверок критических показателей, создайте cron-задачу в интерфейсе OpenClaw, указав нужный период выполения, и заполните описание короткой инструкцией `/check`. Так же для доставки в Telegram нужно добавить в задачу указатель на нужный директ
